      ...
      <div className="max-w-md w-full space-y-8 bg-gray-800 p-10 rounded-xl shadow-2xl border border-green-800/20">
        ...
        {redirectCount !== null ? (
          <div className="text-center py-8">
            <div className="text-3xl font-bold text-green-400 mb-2">¡Bienvenido!</div>
            <p className="text-gray-300 mb-4">Redirigiendo a tu plataforma: {redirectCount} segundo{redirectCount !== 1 ? 's' : ''}...</p>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-green-500 focus:ring-green-500 border-gray-600 rounded bg-gray-700 cursor-pointer"
                />
